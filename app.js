...
<div class="flashcard-bottom-nav">
  <button data-action="shift:-1" aria-label="이전 카드">←</button>
  <button data-action="firstCard" aria-label="처음 카드">🏠</button>
  <button data-action="shift:1" aria-label="다음 카드">→</button>
</div>
    </article>`;
  }
