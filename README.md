...
- `pronNoteKo`: 항목별 실제 주의 포인트 중심의 짧은 발음 팁(필요한 경우만 1~2문장)
...
- 발음 느낌(`pronKo`)과 덩어리 연습(`pronChunks`)은 카드에서 즉시 확인 가능
- 일반적인 반복 문구(예: “끊어 읽고 이어 말하세요”)는 데이터에 중복 저장하지 않음
- 듣기/3회 반복은 카드 하단 **정사각형 2분할 터치 버튼**으로 제공
